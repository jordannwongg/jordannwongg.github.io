        ...
        <div className="flex flex-col space-y-10 items-stretch justify-center align-top md:space-x-10 md:space-y-0 md:p-4 md:flex-row md:text-left">
          <div className="md:w-1/2 ">
            ...
            <p>
              ...
              me and check out my <a href="https://drive.google.com/file/d/1JE3MGxYTH1obydAIndV1yxqjOygmO70Y/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="underline text-blue-500 font-bold">CV</a>!
            </p>
          </div>
